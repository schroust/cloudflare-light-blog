...
export function getFrontendHTML(settings, requestUrl) {
  ...
  const hasSidebar = settings.profile_position === 'left' || settin// ==================== 前台首页（SEO 优化 + 分页）====================
...
gs.tag_cloud_position === 'left' || settings.ad_position === 'left' || settings.profile_position === 'right' || settings.tag_cloud_position === 'right' || settings.ad_position === 'right';
